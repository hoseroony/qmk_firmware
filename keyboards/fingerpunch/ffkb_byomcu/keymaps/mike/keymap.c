 ...
 * `-----------------------------------------'             `-----------------------------------------'
 *          ,------.        ,--------------------.    ,--------------------.        ,------.
 *          | MUTE |        |   \  | WIN  | SYM  |    | NUM  | Space| Del  |        | DELW |
 *          `------'        `--------------------'    `--------------------.        `------'
 */
...
[_QWERTY] = LAYOUT_ffkb(
  ...
  LCTL_T(KC_ESC), KC_Z, KC_X, KC_C, KC_V,         KC_B,         KC_N,    KC_M,         KC_COMM,      KC_DOT,       KC_SLSH,   RSFT_T(KC_ENT),
          KC_MUTE,      KC_BSLS,        KC_LGUI,       LT(_SYMBOLS,KC_HOME),  LT(_NUMBERS,KC_END),   KC_SPC,       KC_DEL,       LCTL(KC_BSPC),
                                                                        LALT(KC_TAB)
),
...
[_NUMBERS] = LAYOUT_ffkb(
  KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,         KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    _______,
  _______, KC_MINS, KC_EQL, _______, _______, KC_BTN1,      KC_BTN2, KC_MINS, KC_UP,  KC_LBRC, KC_RBRC, _______,
  _______, _______, _______, _______, KC_BTN3, KC_BTN1,      KC_BTN2, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______,
